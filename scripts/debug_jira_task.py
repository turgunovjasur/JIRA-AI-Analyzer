...
def debug_jira_task(task_key: str):
    ...
    try:
        ...
        if not task_details:
            ...
            list_db_tasks()
            return
        print("  ✅ Task ma'lumotlari olindi")
    except Exception as e:
    ...
    print(f"\n{'='*60}")
    print("  DESCRIPTION (birinchi 400 belgi)")
    print(f"{'='*60}")
    ...
    # Barcha kalitlar
    print(f"\n{'='*60}")
    print("  BARCHA MAYDONLAR (kalitlar ro'yxati)")
    print(f"{'='*60}")
    ...
    try:
        ...
        if saved_type in allowed_list:
            ...
            print("     yoki sozlamadagi nomlarni JIRA dagi nom bilan moslashtiring")
    except Exception as e:
