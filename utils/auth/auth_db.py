...
def get_global_gemini_defaults() -> dict:
    ...
    return {
        ...
        'agent1_primary_model': get_global_setting('checker_agent1_primary_model'),
        'agent1_fallback_model': get_global_setting('checker_agent1_fallback_model'),
        'agent2_primary_model': get_global_setting('checker_agent2_primary_model'),
        'agent2_fallback_model': get_global_setting('checker_agent2_fallback_model'),
        'agent3_primary_model': get_global_setting('checker_agent3_primary_model'),
        'agent3_fallback_model': get_global_setting('checker_agent3_fallback_model'),
        'testcase_agent1_primary_model': get_global_setting('testcase_agent1_primary_model'),
        'testcase_agent1_fallback_model': get_global_setting('testcase_agent1_fallback_model'),
        'testcase_agent2_primary_model': get_global_setting('testcase_agent2_primary_model'),
        'testcase_agent2_fallback_model': get_global_setting('testcase_agent2_fallback_model'),
        'testcase_agent3_primary_model': get_global_setting('testcase_agent3_primary_model'),
        'testcase_agent3_fallback_model': get_global_setting('testcase_agent3_fallback_model'),
    }
