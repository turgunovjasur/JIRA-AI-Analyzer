...
export async function POST(request: Request) {
  ...
  try {
    ...
    const cleanPayload = {
      ...
      testcase_ai_data_section_order: Array.isArray(payload?.testcase_ai_data_section_order) ? payload!.testcase_ai_data_section_order! : ["tz", "comments", "custom_context", "figma", "code"],
